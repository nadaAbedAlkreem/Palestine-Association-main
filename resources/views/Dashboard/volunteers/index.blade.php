...
@section('content')
	...
	<body id="kt_body">
						...
						<div class="container-fluid" id="kt_content_container">
							...
							<div class="card card-flush">
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-volunteers" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												<th class="min-w-100px">name  </th>        
												<th class="min-w-100px">name_ar  </th>
												<th class="min-w-100px">mobile</th>
												<th class="min-w-100px">email</th>
												<th class="min-w-100px">address</th>
												<th class="min-w-100px">address_ar  </th>
												<th class="min-w-100px">volunteered</th>
												<th class="min-w-100px">volunteered_place</th>
												<th class="min-w-100px">volunteered_place_ar</th>
												<th class="min-w-100px">skills</th>
												<th class="min-w-100px">volunteer_skills</th>
												<th class="min-w-100px">volunteer_skills_ar</th>
												<th class="min-w-100px">beginning_volunteering</th>
												<th class="min-w-100px">end_volunteering</th>
												<th class="min-w-100px">study_experience_volunteer</th>
												<th class="min-w-100px">study_experience_volunteer_ar</th>
												<th class="min-w-100px">cv_voluntee</th>
    	...
    	@endpush
     		...
     		<!-- in this page  -->
 		<script src="{{url('assets/js/custom/actions/volunteers-actions.js')}}"></script>
