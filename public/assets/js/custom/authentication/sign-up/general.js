...
function(){
    var e,t,a,s,r=function(){
        ...
        ;return{init:function(){e=document.querySelector("#kt_sign_up_form"),
        t=document.querySelector("#kt_sign_up_submit")
        ,s=KTPasswordMeter.getInstance(e.querySelector
            ('[data-kt-password-meter="true"]')),a=FormValidation.formValidation(e,
                {fields:{"first-name":{
                    validators:{notEmpty:
                        ...
                        ,callback:{message:"Please enter valid password",callback:function(e)
                            ...
                            ,identical:{compare:function(){
                                ...
                                {notEmpty:
                                    ...
                                    {trigger:new FormValidation.plugins.Trigger
                                        ...
                                        (function(r){r.preventDefault(),a.revalidateField("password"),
                                        a.validate()
                                        .then((function(a){"Valid"==a?
                                        (
                                            ...
                                            // Swal.fire
                                            // ({text:"You have successfully reset your password!",icon:"success",
                                            ...
                                            ((function(t){t.isConfirmed&&(e.reset(),s.reset())}))}),1500)):
                                            ...
                                            customClass:{confirmButton:"btn btn-primary"}})}))}))
                                            ,e.querySelector('input[name="password"]').
