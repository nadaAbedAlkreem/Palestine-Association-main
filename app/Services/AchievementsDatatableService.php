...
class AchievementsDatatableService extends Controller
{
                     ...
                     ->addColumn('action', function ($data)
                      {
                          ...
                          return '
                                    ...
                                    <button type="button"  class="btn btn-xs btn"   
                                     ><a href = "achievements/'.$data->id.'/edit"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
