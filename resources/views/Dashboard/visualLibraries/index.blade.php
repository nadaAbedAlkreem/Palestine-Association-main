...
@section('content')
	...
	<body id="kt_body">
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="">
										...
										<a href="{{route('visualLibraries.create')}}"       class="btn btn-primary">Add visual library</a>
										<!--end::Add product-->
									</div>
									<!--end::Card toolbar-->
								</div>
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-visualLibraries" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
    	...
    	@endpush
     		...
     		<!-- in this page  -->
 		<script src="{{url('assets/js/custom/actions/visual-libraries-actions.js')}}"></script>
