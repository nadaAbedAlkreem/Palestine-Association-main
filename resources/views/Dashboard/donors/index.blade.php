...
@section('content')
	...
	<body id="kt_body">
						...
						<div class="container-fluid" id="kt_content_container">
							...
							<div class="card card-flush">
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-donors" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											...
											<th class="min-w-100px"> project_ar</th> 
											<th class="min-w-100px"> country </th> 
											<th class="min-w-100px"> country_ar </th> 
											<th class="min-w-100px"> city</th> 
											<th class="min-w-100px"> city_ar</th> 
											<th class="min-w-100px"> announcing_donor</th> 
											<th class="min-w-100px"> money		</th> 	
											<th class="min-w-100px"> donation_method</th> 
    	...
    	@endpush
     		...
     		<!-- in this page  -->
 		<script src="{{url('assets/js/custom/actions/donors-actions.js')}}"></script>
