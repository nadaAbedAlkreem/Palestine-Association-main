									...
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-companies" id="kt_ecommerce_products_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
											 <th class="min-w-100px">organization name     </th>
 											 <th class="min-w-100px">organization type     </th>
 											 <th class="min-w-100px">main branch address    </th>
 											 <th class="min-w-100px">social media sites    </th>
											 <th class="min-w-100px">annual budget       </th>
											 <th class="min-w-100px">number of centers       </th>
											 <th class="min-w-100px">number of employees    </th>
											 <th class="min-w-100px">center locations       </th>
 											 <th class="min-w-100px">registration number ministry interior </th>
											 <th class="min-w-100px">Number current projects         </th>
											 <th class="min-w-100px">main donors projects             </th>
											 <th class="min-w-100px">number employees organization      </th>
											 <th class="min-w-100px">nationalities of beneficiaries     </th>
 											 <th class="min-w-100px">age group beneficiaries          </th>
											 <th class="min-w-100px">strategic goals                           </th>
											 <th class="min-w-100px">registration certificate ministry interior</th>
											 <th class="min-w-100px">company organizational structure</th>
