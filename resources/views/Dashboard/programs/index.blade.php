							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="">
										...
										<a href="{{route('programs.create')}}"       class="btn btn-primary">Add  programs</a>
										<!--end::Add product-->
									</div>
									<!--end::Card toolbar-->
								</div>
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-programs" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-100px">brief </th>	 
												<th class="min-w-100px">strategic objective </th>	 
												<th class="min-w-100px">special objectives </th>	 
												<th class="min-w-100px">ativities events </th>	 
