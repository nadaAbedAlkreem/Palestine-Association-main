									...
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-employment-order" id="kt_ecommerce_products_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="min-w-100px"> first_name             </th>         	
												<th class="min-w-100px"> father_name</th>
												<th class="min-w-100px"> grandfather_name</th>
												<th class="min-w-100px"> family_name  </th>
												<th class="min-w-100px"> first_name_ar </th>
												<th class="min-w-100px"> father_name_ar</th>
												<th class="min-w-100px"> grandfather_name_ar</th>
												<th class="min-w-100px"> family_name_ar</th>
												<th class="min-w-100px"> mobile</th>
												<th class="min-w-100px"> email</th>
												<th class="min-w-100px"> gender</th>
												<th class="min-w-100px"> gender_ar</th>
												<th class="min-w-100px"> qualification</th>
												<th class="min-w-100px"> Birthday</th>
