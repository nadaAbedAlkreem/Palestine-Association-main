...
<div class="post d-flex flex-column-fluid" id="kt_post">
                            ...
                            <div id="kt_content_container" class="container-xxl">
											 		<form id="SubmitFormAchievementEdit"  class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html"  enctype="multipart/form-data">
 											           @csrf		 	
                                                    ...
                                                    <!--begin::Select2-->
												              	<label class="form-label">image</label>
																	...
																	<div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(/storage2/{{$achievements->image}})">
...
@endif
		...
		<script  type= text/javascript>
			 ...
			 $('#SubmitFormAchievementEdit').on('submit',function(e)
            {      
                    e.preventDefault();
             

                    let formData = new FormData($('#SubmitFormAchievementEdit')[0]);
